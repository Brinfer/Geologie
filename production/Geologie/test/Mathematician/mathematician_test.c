...
//  *
//  */
// ParametersTestCalculDistancePosition parametersTestPosition[] = {
//     //                                                                     | <---------X---------> | <---------Y---------> |
...
// {
//     // Position
//     cmocka_unit_test_prestate(distanceCalculWithPosition, &(parametersTestPosition[0])),
//     cmocka_unit_test_prestate(distanceCalculWithPosition, &(parametersTestPosition[1])),
//     cmocka_unit_test_prestate(distanceCalculWithPosition, &(parametersTestPosition[2])),
//     cmocka_unit_test_prestate(distanceCalculWithPosition, &(parametersTestPosition[3])),
//     cmocka_unit_test_prestate(distanceCalculWithPosition, &(parametersTestPosition[4]))
...
//     assert_float_equal(result, param->expectedResult,);
// }
